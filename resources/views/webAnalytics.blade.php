...
<div class="az-content az-content-dashboard-two">
    <div class="az-content-header d-block d-md-flex" style="padding-bottom: 10px;">
        <div>
            ...
            <p class="mg-b-0">Your Web Analytics Monitoring Dashboard.</p>
        </div>
                ...
                <div class="row row-sm">
                    <div class="col-sm-6">
                        <div class="card card-dashboard-two">
                            <div class="card-header">
                                <h6>33.50% <i class="icon ion-md-trending-up tx-success"></i> <small>18.02%</small>
                                </h6>
                                <p>Bounce Rate</p>
                            </div><!-- card-header -->
                            <div class="card-body">
                        ...
                        <div class="card card-dashboard-three">
                            <div class="card-header">
                                ...
                                <h6>16,869 <small class="tx-success"><i class="icon ion-md-arrow-up"></i>
                                        2.87%</small></h6>
                                <small>The total number of sessions within the date range. It is the period time a
                    ...
                    <div class="col-md-6 col-lg-12 mg-b-20 mg-md-b-0 mg-lg-b-20">
                        <div class="card card-dashboard-five">
                            <div class="card-header">
                                ...
                                <span class="card-text">Tells you where your visitors originated from, such as search
                                    engines, social networks or website referrals.</span>
                            </div><!-- card-header -->
                    ...
                    <div class="col-md-6 col-lg-12">
                        <div class="card card-dashboard-five">
                            <div class="card-header">
                                ...
                                <span class="card-text"> A session is the period time a user is actively engaged with
                                    your website, app, etc.</span>
                            </div><!-- card-header -->
                            <div class="card-body row row-sm">
                                <div class="col-6 d-sm-flex align-items-center">
...
//flotChart1
            var flotChartoptions = {
                ...
                xaxis: {
                    show: true,
                    color: '#fff',
                    ticks: [[25, 'APR 21'], [75, 'APR 22'], [100, 'APR 23'], [125, 'APR 24'],[125, 'APR 25'],[125, 'APR 26'],[125, 'APR 27'],[125, 'APR 28'],[125, 'APR 29']],
                }
            };
            ...
            //var plot = $.plot('#flotChart', flotchartdata, flotChartoptions);
