    ...
    <div class="az-sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item active show">
                <a href="{{ route('web') }}" class="nav-link with-sub"><i
                        class="typcn typcn-clipboard"></i>Dashboard</a>
                <nav class="nav-sub">
                    <a href="{{ route('web') }}" class="nav-sub-link"
                       id="{{Request::is('webAnalytics') ? 'high' : ''}}">Web Analytics</a>
                    <a href="{{ route('sales') }}" class="nav-sub-link"
                       id="{{Request::is('salesAnalytics') ? 'high' : ''}}">Sales Monitoring</a>
                    <a href="{{ route('app') }}" class="nav-sub-link"
                       id="{{Request::is('appAnalytics') ? 'high' : ''}}">App Analytics</a>
                    <a href="{{ route('help') }}" class="nav-sub-link" id="{{Request::is('help') ? 'high' : ''}}">Help
                        Desk</a>
                    <a href="{{ route('finance') }}" class="nav-sub-link" id="{{Request::is('finance') ? 'high' : ''}}">Finance
                        Monitoring</a>
                    <a href="{{ route('product') }}" class="nav-sub-link"
                       id="{{Request::is('products') ? 'high' : ''}}">Product Management</a>
                </nav>
            </li><!-- nav-item -->
            <li class="nav-item">
            ...
            <div class="az-header-right">
                <div class="dropdown az-header-notification">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <p class="az-notification-text">You have <span>2</span> unread notification</p>
    ...
    function CheckNotification() {
        $.ajax({
            ...
            success: function (data) {
                console.log("success ajax notification");
                console.log( "{{ route('api.notification') }}");
                $('.az-notification-list').prepend("<div class=\"media\">\n" +
                    "                                <div class=\"az-img-user\"><img src=\"" + data.data.img+"\" alt=\"\">\n" +
                    "                                </div>\n" +
                    "                                <div class=\"media-body\">\n" +
                    "                                    <p><strong>"+data.data.title+"</strong> "+data.data.situation+"</p>\n" +
                    "                                    <span>"+data.data.date+"</span>\n" +
                    "                                </div><!-- media-body -->\n" +
                    "                            </div><!-- media -->\n");
                $(".az-notification-text span").text(parseInt($(".az-notification-text span").text()) + 1 );
            },
            error: function (data) {
                console.log("Error ajax notification");
            }
