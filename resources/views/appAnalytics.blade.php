                ...
                <div class="card card-dashboard-one">
                    <div class="card-header">
                        <div>
                            ...
                            <p class="card-text">Audience to which the users belonged while on the current date range.
                            </p>
                        </div>
                        <div class="btn-group">
                ...
                <div class="row row-sm">
                    ...
                    <div class="col-sm-12 mg-t-20">
                        <div class="card card-dashboard-three">
                            <div class="card-header">
                                <p>All Sessions</p>
                                <h6>16,869 <small class="tx-success"><i class="icon ion-md-arrow-up"></i> 2.87%</small>
                                </h6>
                                <small>The total number of sessions within the date range. It is the period time a user
                                    is actively engaged with your website, page or app, etc.</small>
                            </div><!-- card-header -->
                            <div class="card-body">
            ...
            function updatechart1() {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log("success");
                        flotSampleData3 = data.data1;
                        flotSampleData4 = data.data2;
                        flotchartdata = [{
